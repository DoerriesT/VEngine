...
void VEngine::ShadowPass::addToGraph(rg::RenderGraph &graph, const Data &data)
{
	...
	graph.addPass(data.m_alphaMasked ? "Shadows Alpha" : "Shadows", rg::QueueType::GRAPHICS, sizeof(passUsages) / sizeof(passUsages[0]), passUsages, [=](CommandList *cmdList, const rg::Registry &registry)
	{
