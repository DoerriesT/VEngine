...
void VEngine::HiZPyramidPass2::addToGraph(rg::RenderGraph2 &graph, const Data &data, OutData &outData)
{
	uint32_t levels = 1;
	{
	...
	graph.addPass("Hi-Z Pyramid", rg::QueueType::GRAPHICS, levels + 1, passUsages, [=](CommandList *cmdList, const rg::Registry2 &registry)
		{
