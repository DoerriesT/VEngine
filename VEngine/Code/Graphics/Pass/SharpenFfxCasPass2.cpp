...
void VEngine::SharpenFfxCasPass2::addToGraph(rg::RenderGraph2 &graph, const Data &data)
{
	...
	graph.addPass("Sharpen (FFX CAS)", rg::QueueType::GRAPHICS, sizeof(passUsages) / sizeof(passUsages[0]), passUsages, [=](CommandList *cmdList, const rg::Registry2 &registry)
		{
