...
void VEngine::ImGuiPass2::addToGraph(rg::RenderGraph2 &graph, const Data &data)
{
	...
	graph.addPass("ImGui", rg::QueueType::GRAPHICS, sizeof(passUsages) / sizeof(passUsages[0]), passUsages, [=](CommandList *cmdList, const rg::Registry2 &registry)
	{
		...
		// begin renderpass
		ColorAttachmentDescription colorAttachDesc{ registry.getImageView(data.m_resultImageViewHandle), AttachmentLoadOp::LOAD, AttachmentStoreOp::STORE, {} };
