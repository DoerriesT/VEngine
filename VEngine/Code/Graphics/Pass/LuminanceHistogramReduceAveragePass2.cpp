#include "LuminanceHistogramReduceAveragePass2.h"
...
void VEngine::LuminanceHistogramAveragePass2::addToGraph(rg::RenderGraph2 &graph, const Data &data)
{
	...
	graph.addPass("Luminance Histogram Average", rg::QueueType::GRAPHICS, sizeof(passUsages) / sizeof(passUsages[0]), passUsages, [=](CommandList *cmdList, const rg::Registry2 &registry)
	{
