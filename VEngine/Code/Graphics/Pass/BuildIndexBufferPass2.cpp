#include "BuildIndexBufferPass2.h"
...
void VEngine::BuildIndexBufferPass2::addToGraph(rg::RenderGraph2 &graph, const Data &data)
{
	struct ClusterInfo
	{
		uint32_t indexCount;
	...
	graph.addPass("Build Index Buffer", data.m_async ? rg::QueueType::COMPUTE : rg::QueueType::GRAPHICS, sizeof(passUsages) / sizeof(passUsages[0]), passUsages, [=](CommandList *cmdList, const rg::Registry2 &registry)
		{
