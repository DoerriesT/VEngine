...
void VEngine::RasterTilingPass2::addToGraph(rg::RenderGraph2 &graph, const Data &data)
{
	...
	graph.addPass("Raster Tiling", rg::QueueType::GRAPHICS, sizeof(passUsages) / sizeof(passUsages[0]), passUsages, [=](CommandList *cmdList, const rg::Registry2 &registry)
	{
