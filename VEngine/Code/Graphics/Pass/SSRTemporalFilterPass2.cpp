#include "SSRTemporalFilterPass2.h"
...
void VEngine::SSRTemporalFilterPass2::addToGraph(rg::RenderGraph2 &graph, const Data &data)
{
	...
	graph.addPass("SSR Temporal Filter", rg::QueueType::GRAPHICS, sizeof(passUsages) / sizeof(passUsages[0]), passUsages, [=](CommandList *cmdList, const rg::Registry2 &registry)
		{
