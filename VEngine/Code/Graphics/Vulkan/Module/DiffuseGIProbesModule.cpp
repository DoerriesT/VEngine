...
void VEngine::DiffuseGIProbesModule::addProbeUpdateToGraph(RenderGraph &graph, const Data &data)
{
	...
	irradianceVolumeRayMarchingPassData.m_binVisBricksImageHandle = data.m_binVisBricksImageViewHandle;
	irradianceVolumeRayMarchingPassData.m_colorBricksImageHandle = data.m_colorBricksImageViewHandle;
