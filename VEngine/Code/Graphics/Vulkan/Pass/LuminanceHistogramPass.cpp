...
void VEngine::LuminanceHistogramPass::addToGraph(RenderGraph &graph, const Data &data)
{
	...
	graph.addPass("Luminance Histogram", QueueType::GRAPHICS, sizeof(passUsages) / sizeof(passUsages[0]), passUsages, [=](VkCommandBuffer cmdBuf, const Registry &registry)
	{
		...
		// update descriptor sets
		{
			...
			writer.writeImageInfo(VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE, registry.getImageInfo(data.m_lightImageHandle, ResourceState::READ_TEXTURE_COMPUTE_SHADER), SOURCE_IMAGE_BINDING);
