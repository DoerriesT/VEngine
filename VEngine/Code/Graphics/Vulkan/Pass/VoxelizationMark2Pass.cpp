#include "VoxelizationMark2Pass.h"
...
{
	using namespace glm;
#include "../../../../../Application/Resources/Shaders/voxelizationMark2_bindings.h"
}

void VEngine::VoxelizationMark2Pass::addToGraph(RenderGraph &graph, const Data &data)
{
	...
	graph.addPass("Voxelization Mark 2", QueueType::GRAPHICS, sizeof(passUsages) / sizeof(passUsages[0]), passUsages, [=](VkCommandBuffer cmdBuf, const Registry &registry)
		{
			...
			pipelineDesc.setComputeShader("Resources/Shaders/voxelizationMark2_comp.spv");
