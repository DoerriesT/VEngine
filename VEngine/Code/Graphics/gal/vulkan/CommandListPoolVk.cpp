...
VEngine::gal::CommandListPoolVk::CommandListPoolVk(GraphicsDeviceVk &device, const QueueVk &queue)
	:m_device(&device),
...
VEngine::gal::CommandListPoolVk::~CommandListPoolVk()
{
...
void VEngine::gal::CommandListPoolVk::reset()
{
