...
#include "Graphics/Pass/BloomDownsamplePass.h"
#include "Graphics/Pass/BloomUpsamplePass.h"
#include "Graphics/PassRecordContext.h"
#include "Graphics/RenderData.h"

using namespace VEngine::gal;

void VEngine::BloomModule::addToGraph(rg::RenderGraph &graph, const InputData &inData, OutputData &outData)
{
	// create images
