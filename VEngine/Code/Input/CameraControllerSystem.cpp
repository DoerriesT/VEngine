...
void VEngine::CameraControllerSystem::update(float timeDelta)
{
	auto view = m_entityRegistry.view<TransformationComponent, CameraComponent>();

	view.each([this, timeDelta](TransformationComponent &transformationComponent, CameraComponent &cameraComponent)
	{
