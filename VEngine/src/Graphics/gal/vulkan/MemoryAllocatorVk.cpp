...
VkResult VEngine::gal::MemoryAllocatorVk::createImage(const AllocationCreateInfoVk &allocationCreateInfo, const VkImageCreateInfo &imageCreateInfo, VkImage &image, AllocationHandleVk &allocationHandle)
{
...
VkResult VEngine::gal::MemoryAllocatorVk::createBuffer(const AllocationCreateInfoVk &allocationCreateInfo, const VkBufferCreateInfo &bufferCreateInfo, VkBuffer &buffer, AllocationHandleVk &allocationHandle)
{
...
void VEngine::gal::MemoryAllocatorVk::free(AllocationHandleVk allocationHandle)
{
	AllocationInfoVk *allocationInfo = reinterpret_cast<AllocationInfoVk *>(allocationHandle);
...
void VEngine::gal::MemoryAllocatorVk::destroyImage(VkImage image, AllocationHandleVk allocationHandle)
{
	vkDestroyImage(m_device, image, nullptr);
	free(allocationHandle);
}

void VEngine::gal::MemoryAllocatorVk::destroyBuffer(VkBuffer buffer, AllocationHandleVk allocationHandle)
{
	vkDestroyBuffer(m_device, buffer, nullptr);
	free(allocationHandle);
}

VkResult VEngine::gal::MemoryAllocatorVk::mapMemory(AllocationHandleVk allocationHandle, void **data)
{
	AllocationInfoVk *allocationInfo = reinterpret_cast<AllocationInfoVk *>(allocationHandle);
...
void VEngine::gal::MemoryAllocatorVk::unmapMemory(AllocationHandleVk allocationHandle)
{
	AllocationInfoVk *allocationInfo = reinterpret_cast<AllocationInfoVk *>(allocationHandle);
...
std::vector<VEngine::gal::MemoryBlockDebugInfoVk> VEngine::gal::MemoryAllocatorVk::getDebugInfo() const
{
...
size_t VEngine::gal::MemoryAllocatorVk::getMaximumBlockSize() const
{
	return MAX_BLOCK_SIZE;
}

void VEngine::gal::MemoryAllocatorVk::getFreeUsedWastedSizes(size_t &free, size_t &used, size_t &wasted) const
{
	free = 0;
	used = 0;
	wasted = 0;
...
void VEngine::gal::MemoryAllocatorVk::destroy()
{
	for (uint32_t i = 0; i < m_memoryProperties.memoryTypeCount; ++i)
	{
		m_pools[i].destroy();
...
VkResult VEngine::gal::MemoryAllocatorVk::findMemoryTypeIndex(uint32_t memoryTypeBitsRequirement, VkMemoryPropertyFlags requiredProperties, VkMemoryPropertyFlags preferredProperties, uint32_t &memoryTypeIndex)
{
...
VkResult VEngine::gal::MemoryAllocatorVk::MemoryPoolVk::alloc(VkDeviceSize size, VkDeviceSize alignment, AllocationInfoVk &allocationInfo)
{
...
void VEngine::gal::MemoryAllocatorVk::MemoryPoolVk::free(AllocationInfoVk allocationInfo)
{
...
VkResult VEngine::gal::MemoryAllocatorVk::MemoryPoolVk::mapMemory(size_t blockIndex, VkDeviceSize offset, void **data)
{
	VkResult result = VK_SUCCESS;
...
void VEngine::gal::MemoryAllocatorVk::MemoryPoolVk::unmapMemory(size_t blockIndex)
{
...
void VEngine::gal::MemoryAllocatorVk::MemoryPoolVk::getFreeUsedWastedSizes(size_t &free, size_t &used, size_t &wasted) const
{
	free = 0;
	used = 0;
	wasted = 0;
...
void VEngine::gal::MemoryAllocatorVk::MemoryPoolVk::getDebugInfo(std::vector<MemoryBlockDebugInfoVk> &result) const
{
	for (size_t blockIndex = 0; blockIndex < MAX_BLOCKS; ++blockIndex)
	{
...
void VEngine::gal::MemoryAllocatorVk::MemoryPoolVk::destroy()
{
	for (size_t blockIndex = 0; blockIndex < MAX_BLOCKS; ++blockIndex)
	{
		if (m_blockSizes[blockIndex])
...
bool VEngine::gal::MemoryAllocatorVk::MemoryPoolVk::allocFromBlock(size_t blockIndex, VkDeviceSize size, VkDeviceSize alignment, AllocationInfoVk &allocationInfo)
{
