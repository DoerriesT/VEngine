...
VEngine::gal::FramebufferDescriptionVk::FramebufferDescriptionVk()
{
	memset(this, 0, sizeof(*this));
}

void VEngine::gal::FramebufferDescriptionVk::setRenderPass(VkRenderPass renderPass)
{
	m_renderPass = renderPass;
}

void VEngine::gal::FramebufferDescriptionVk::setAttachments(uint32_t count, const AttachmentInfoVk *attachmentInfos)
{
	assert(count <= 9);
...
void VEngine::gal::FramebufferDescriptionVk::setExtent(uint32_t width, uint32_t height, uint32_t layers)
{
	m_width = width;
	m_height = height;
	m_layers = layers;
...
void VEngine::gal::FramebufferDescriptionVk::finalize()
{
	m_hashValue = 0;
...
bool VEngine::gal::operator==(const FramebufferDescriptionVk &lhs, const FramebufferDescriptionVk &rhs)
{
	return memcmp(&lhs, &rhs, sizeof(lhs)) == 0;
}

size_t VEngine::gal::FramebufferDescriptionHashVk::operator()(const FramebufferDescriptionVk &value) const
{
	return value.m_hashValue;
}

VEngine::gal::FramebufferCacheVk::FramebufferCacheVk(VkDevice device)
	:m_framebuffers(),
	m_device(device)
{
}

VEngine::gal::FramebufferCacheVk::~FramebufferCacheVk()
{
...
VkFramebuffer VEngine::gal::FramebufferCacheVk::getFramebuffer(const FramebufferDescriptionVk &framebufferDescription)
{
