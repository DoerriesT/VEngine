...
VkComponentSwizzle VEngine::gal::UtilityVk::translate(gal::ComponentSwizzle swizzle)
{
	switch (swizzle)
	{
...
VkFilter VEngine::gal::UtilityVk::translate(gal::Filter filter)
{
	switch (filter)
	{
	case Filter::NEAREST:
...
VkSamplerMipmapMode VEngine::gal::UtilityVk::translate(gal::SamplerMipmapMode mipmapMode)
{
	switch (mipmapMode)
	{
...
VkSamplerAddressMode VEngine::gal::UtilityVk::translate(gal::SamplerAddressMode addressMode)
{
	switch (addressMode)
	{
...
VkBorderColor VEngine::gal::UtilityVk::translate(gal::BorderColor borderColor)
{
	switch (borderColor)
	{
...
VkIndexType VEngine::gal::UtilityVk::translate(gal::IndexType indexType)
{
	switch (indexType)
	{
...
VkQueryType VEngine::gal::UtilityVk::translate(gal::QueryType queryType)
{
	switch (queryType)
	{
...
VkAttachmentLoadOp VEngine::gal::UtilityVk::translate(gal::AttachmentLoadOp loadOp)
{
	switch (loadOp)
	{
...
VkAttachmentStoreOp VEngine::gal::UtilityVk::translate(gal::AttachmentStoreOp storeOp)
{
	switch (storeOp)
	{
...
VkVertexInputRate VEngine::gal::UtilityVk::translate(gal::VertexInputRate inputRate)
{
	switch (inputRate)
	{
...
VkFormat VEngine::gal::UtilityVk::translate(gal::Format format)
{
	switch (format)
	{
...
VkImageViewType VEngine::gal::UtilityVk::translate(gal::ImageViewType imageViewType)
{
...
VkImageType VEngine::gal::UtilityVk::translate(gal::ImageType imageType)
{
	switch (imageType)
	{
	case ImageType::_1D:
...
VkPrimitiveTopology VEngine::gal::UtilityVk::translate(gal::PrimitiveTopology primitiveTopology)
{
...
VkPolygonMode VEngine::gal::UtilityVk::translate(gal::PolygonMode polygonMode)
{
	switch (polygonMode)
	{
...
VkFrontFace VEngine::gal::UtilityVk::translate(gal::FrontFace frontFace)
{
	switch (frontFace)
	{
...
VkCompareOp VEngine::gal::UtilityVk::translate(gal::CompareOp compareOp)
{
	switch (compareOp)
	{
...
VkStencilOp VEngine::gal::UtilityVk::translate(gal::StencilOp stencilOp)
{
	switch (stencilOp)
	{
	case StencilOp::KEEP:
...
VkLogicOp VEngine::gal::UtilityVk::translate(gal::LogicOp logicOp)
{
	switch (logicOp)
	{
	case LogicOp::CLEAR:
...
VkBlendOp VEngine::gal::UtilityVk::translate(gal::BlendOp blendOp)
{
	switch (blendOp)
	{
	case BlendOp::ADD:
...
VkShaderStageFlags VEngine::gal::UtilityVk::translateShaderStageFlags(gal::ShaderStageFlags flags)
{
	VkShaderStageFlags result = 0;

	if (testFlagBit(flags, ShaderStageFlagBits::VERTEX_BIT))
	{
		result |= VK_SHADER_STAGE_VERTEX_BIT;
	}
	if (testFlagBit(flags, ShaderStageFlagBits::TESSELLATION_CONTROL_BIT))
	{
		result |= VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT;
	}
	if (testFlagBit(flags, ShaderStageFlagBits::TESSELLATION_EVALUATION_BIT))
	{
		result |= VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT;
	}
	if (testFlagBit(flags, ShaderStageFlagBits::GEOMETRY_BIT))
	{
		result |= VK_SHADER_STAGE_GEOMETRY_BIT;
	}
	if (testFlagBit(flags, ShaderStageFlagBits::FRAGMENT_BIT))
	{
		result |= VK_SHADER_STAGE_FRAGMENT_BIT;
	}
	if (testFlagBit(flags, ShaderStageFlagBits::COMPUTE_BIT))
	{
...
VkMemoryPropertyFlags VEngine::gal::UtilityVk::translateMemoryPropertyFlags(gal::MemoryPropertyFlags flags)
{
	VkMemoryPropertyFlags result = 0;

	if (testFlagBit(flags, MemoryPropertyFlagBits::DEVICE_LOCAL_BIT))
	{
		result |= VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT;
	}
	if (testFlagBit(flags, MemoryPropertyFlagBits::HOST_VISIBLE_BIT))
	{
		result |= VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT;
	}
	if (testFlagBit(flags, MemoryPropertyFlagBits::HOST_COHERENT_BIT))
	{
		result |= VK_MEMORY_PROPERTY_HOST_COHERENT_BIT;
	}
	if (testFlagBit(flags, MemoryPropertyFlagBits::HOST_CACHED_BIT))
	{
...
VkQueryPipelineStatisticFlags VEngine::gal::UtilityVk::translateQueryPipelineStatisticFlags(gal::QueryPipelineStatisticFlags flags)
{
	VkQueryPipelineStatisticFlags result = 0;

	if (testFlagBit(flags, QueryPipelineStatisticFlagBits::INPUT_ASSEMBLY_VERTICES_BIT))
	{
		result |= VK_QUERY_PIPELINE_STATISTIC_INPUT_ASSEMBLY_VERTICES_BIT;
	}
	if (testFlagBit(flags, QueryPipelineStatisticFlagBits::INPUT_ASSEMBLY_PRIMITIVES_BIT))
	{
		result |= VK_QUERY_PIPELINE_STATISTIC_INPUT_ASSEMBLY_PRIMITIVES_BIT;
	}
	if (testFlagBit(flags, QueryPipelineStatisticFlagBits::VERTEX_SHADER_INVOCATIONS_BIT))
	{
		result |= VK_QUERY_PIPELINE_STATISTIC_VERTEX_SHADER_INVOCATIONS_BIT;
	}
	if (testFlagBit(flags, QueryPipelineStatisticFlagBits::GEOMETRY_SHADER_INVOCATIONS_BIT))
	{
		result |= VK_QUERY_PIPELINE_STATISTIC_GEOMETRY_SHADER_INVOCATIONS_BIT;
	}
	if (testFlagBit(flags, QueryPipelineStatisticFlagBits::GEOMETRY_SHADER_PRIMITIVES_BIT))
	{
		result |= VK_QUERY_PIPELINE_STATISTIC_GEOMETRY_SHADER_PRIMITIVES_BIT;
	}
	if (testFlagBit(flags, QueryPipelineStatisticFlagBits::CLIPPING_INVOCATIONS_BIT))
	{
		result |= VK_QUERY_PIPELINE_STATISTIC_CLIPPING_INVOCATIONS_BIT;
	}
	if (testFlagBit(flags, QueryPipelineStatisticFlagBits::CLIPPING_PRIMITIVES_BIT))
	{
		result |= VK_QUERY_PIPELINE_STATISTIC_CLIPPING_PRIMITIVES_BIT;
	}
	if (testFlagBit(flags, QueryPipelineStatisticFlagBits::FRAGMENT_SHADER_INVOCATIONS_BIT))
	{
		result |= VK_QUERY_PIPELINE_STATISTIC_FRAGMENT_SHADER_INVOCATIONS_BIT;
	}
	if (testFlagBit(flags, QueryPipelineStatisticFlagBits::TESSELLATION_CONTROL_SHADER_PATCHES_BIT))
	{
		result |= VK_QUERY_PIPELINE_STATISTIC_TESSELLATION_CONTROL_SHADER_PATCHES_BIT;
	}
	if (testFlagBit(flags, QueryPipelineStatisticFlagBits::TESSELLATION_EVALUATION_SHADER_INVOCATIONS_BIT))
	{
		result |= VK_QUERY_PIPELINE_STATISTIC_TESSELLATION_EVALUATION_SHADER_INVOCATIONS_BIT;
	}
	if (testFlagBit(flags, QueryPipelineStatisticFlagBits::COMPUTE_SHADER_INVOCATIONS_BIT))
	{
...
VkStencilFaceFlags VEngine::gal::UtilityVk::translateStencilFaceFlags(gal::StencilFaceFlags flags)
{
	VkStencilFaceFlags result = 0;

	if (testFlagBit(flags, StencilFaceFlagBits::FRONT_BIT))
	{
		result |= VK_STENCIL_FACE_FRONT_BIT;
	}
	if (testFlagBit(flags, StencilFaceFlagBits::BACK_BIT))
	{
		result |= VK_STENCIL_FACE_BACK_BIT;
	}
	if (testFlagBit(flags, StencilFaceFlagBits::FRONT_AND_BACK))
	{
...
VkPipelineStageFlags VEngine::gal::UtilityVk::translatePipelineStageFlags(gal::PipelineStageFlags flags)
{
	VkPipelineStageFlags result = 0;

	if (testFlagBit(flags, PipelineStageFlagBits::TOP_OF_PIPE_BIT))
	{
		result |= VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::DRAW_INDIRECT_BIT))
	{
		result |= VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::VERTEX_INPUT_BIT))
	{
		result |= VK_PIPELINE_STAGE_VERTEX_INPUT_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::VERTEX_SHADER_BIT))
	{
		result |= VK_PIPELINE_STAGE_VERTEX_SHADER_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::TESSELLATION_CONTROL_SHADER_BIT))
	{
		result |= VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::TESSELLATION_EVALUATION_SHADER_BIT))
	{
		result |= VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::GEOMETRY_SHADER_BIT))
	{
		result |= VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::FRAGMENT_SHADER_BIT))
	{
		result |= VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::EARLY_FRAGMENT_TESTS_BIT))
	{
		result |= VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::LATE_FRAGMENT_TESTS_BIT))
	{
		result |= VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::COLOR_ATTACHMENT_OUTPUT_BIT))
	{
		result |= VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::COMPUTE_SHADER_BIT))
	{
		result |= VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::TRANSFER_BIT))
	{
		result |= VK_PIPELINE_STAGE_TRANSFER_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::BOTTOM_OF_PIPE_BIT))
	{
		result |= VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::HOST_BIT))
	{
		result |= VK_PIPELINE_STAGE_HOST_BIT;
	}
	if (testFlagBit(flags, PipelineStageFlagBits::CLEAR_BIT))
	{
		result |= VK_PIPELINE_STAGE_TRANSFER_BIT;
	}
...
VkImageUsageFlags VEngine::gal::UtilityVk::translateImageUsageFlags(gal::ImageUsageFlags flags)
{
...
VkImageCreateFlags VEngine::gal::UtilityVk::translateImageCreateFlags(gal::ImageCreateFlags flags)
{
	VkImageCreateFlags result = 0;

	if (testFlagBit(flags, ImageCreateFlagBits::MUTABLE_FORMAT_BIT))
	{
		result |= VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT;
	}
	if (testFlagBit(flags, ImageCreateFlagBits::CUBE_COMPATIBLE_BIT))
	{
		result |= VK_IMAGE_CREATE_CUBE_COMPATIBLE_BIT;
	}
	if (testFlagBit(flags, ImageCreateFlagBits::_2D_ARRAY_COMPATIBLE_BIT))
	{
...
VkBufferUsageFlags VEngine::gal::UtilityVk::translateBufferUsageFlags(gal::BufferUsageFlags flags)
{
...
VkBufferCreateFlags VEngine::gal::UtilityVk::translateBufferCreateFlags(gal::BufferCreateFlags flags)
{
...
VkCullModeFlags VEngine::gal::UtilityVk::translateCullModeFlags(gal::CullModeFlags flags)
{
	VkCullModeFlags result = 0;

	if (testFlagBit(flags, CullModeFlagBits::NONE))
	{
		result |= VK_CULL_MODE_NONE;
	}
	if (testFlagBit(flags, CullModeFlagBits::FRONT_BIT))
	{
		result |= VK_CULL_MODE_FRONT_BIT;
	}
	if (testFlagBit(flags, CullModeFlagBits::BACK_BIT))
	{
		result |= VK_CULL_MODE_BACK_BIT;
	}
	if (testFlagBit(flags, CullModeFlagBits::FRONT_AND_BACK))
	{
...
VkColorComponentFlags VEngine::gal::UtilityVk::translateColorComponentFlags(gal::ColorComponentFlags flags)
{
	VkColorComponentFlags result = 0;

	if (testFlagBit(flags, ColorComponentFlagBits::R_BIT))
	{
		result |= VK_COLOR_COMPONENT_R_BIT;
	}
	if (testFlagBit(flags, ColorComponentFlagBits::G_BIT))
	{
		result |= VK_COLOR_COMPONENT_G_BIT;
	}
	if (testFlagBit(flags, ColorComponentFlagBits::B_BIT))
	{
		result |= VK_COLOR_COMPONENT_B_BIT;
	}
	if (testFlagBit(flags, ColorComponentFlagBits::A_BIT))
	{
...
VkQueryResultFlags VEngine::gal::UtilityVk::translateQueryResultFlags(gal::QueryResultFlags flags)
{
	VkQueryResultFlags result = 0;

	if (testFlagBit(flags, QueryResultFlagBits::_64_BIT))
	{
		result |= VK_QUERY_RESULT_64_BIT;
	}
	if (testFlagBit(flags, QueryResultFlagBits::WAIT_BIT))
	{
		result |= VK_QUERY_RESULT_WAIT_BIT;
	}
	if (testFlagBit(flags, QueryResultFlagBits::WITH_AVAILABILITY_BIT))
	{
		result |= VK_QUERY_RESULT_WITH_AVAILABILITY_BIT;
	}
	if (testFlagBit(flags, QueryResultFlagBits::PARTIAL_BIT))
	{
