...
VEngine::gal::CommandListPoolDx12::~CommandListPoolDx12()
{
...
void *VEngine::gal::CommandListPoolDx12::getNativeHandle() const
{
	// this class doesnt map to any native D3D12 concept
	return nullptr;
}

void VEngine::gal::CommandListPoolDx12::allocate(uint32_t count, CommandList **commandLists)
{
...
void VEngine::gal::CommandListPoolDx12::free(uint32_t count, CommandList **commandLists)
{
	for (size_t i = 0; i < count; ++i)
	{
...
void VEngine::gal::CommandListPoolDx12::reset()
{
	for (auto &cmdList : m_liveCmdLists)
	{
		cmdList->reset();
