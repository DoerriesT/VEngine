...
VEngine::gal::SwapChainDx12::SwapChainDx12(GraphicsDeviceDx12 *graphicsDevice, ID3D12Device *device, void *windowHandle, Queue *presentQueue, uint32_t width, uint32_t height, bool fullscreen, PresentMode presentMode)
...
void VEngine::gal::SwapChainDx12::resize(uint32_t width, uint32_t height, bool fullscreen, PresentMode presentMode)
{
