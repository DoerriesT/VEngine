...
void VEngine::ReadBackCopyPass::addToGraph(rg::RenderGraph &graph, const Data &data)
{
	...
	graph.addPass("Read Back Copy", rg::QueueType::GRAPHICS, sizeof(passUsages) / sizeof(passUsages[0]), passUsages, [=](CommandList *cmdList, const rg::Registry &registry)
		{
