	...
	graph.addPass("Fourier Opacity PS", rg::QueueType::GRAPHICS, sizeof(passUsages) / sizeof(passUsages[0]), passUsages, [=](CommandList *cmdList, const rg::Registry &registry)
		{
			...
			DescriptorSet *fomVolumeDescriptorSet;
			{
				...
				// global pipeline
				{
					...
					builder.setFragmentShader("Resources/Shaders/hlsl/fourierOpacityGlobal_ps");
				...
				// volume pipeline
				{
					...
					builder.setVertexShader("Resources/Shaders/hlsl/fourierOpacityVolume_vs");
					builder.setFragmentShader("Resources/Shaders/hlsl/fourierOpacityVolume_ps");
