...
void VEngine::SSRModule::addToGraph(rg::RenderGraph &graph, const Data &data)
{
	...
	ssrPassData.m_normalRoughnessImageHandle = data.m_normalRoughnessImageViewHandle;
	...
	ssrResolvePassData.m_normalRoughnessImageHandle = data.m_normalRoughnessImageViewHandle;
	ssrResolvePassData.m_albedoMetalnessImageHandle = data.m_albedoMetalnessImageViewHandle;
