...
#define REFLECTION_PROBE_IMAGE_BINDING 6
#define REFLECTION_PROBE_DATA_BINDING 7
#define REFLECTION_PROBE_BIT_MASK_BINDING 8
#define REFLECTION_PROBE_Z_BINS_BINDING 9
#define EXPOSURE_DATA_BUFFER_BINDING 10
#define SSAO_IMAGE_BINDING 11
