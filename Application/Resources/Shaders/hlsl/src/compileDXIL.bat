...
dxc.exe -T cs_6_2 -E main volumetricFogVBuffer_cs.hlsl -Fo ./../volumetricFogVBuffer_cs.dxil -Zi -Fd ./../volumetricFogVBuffer_cs.pdb
...
dxc.exe -T cs_6_2 -E main volumetricFogExtinctionVolume_cs.hlsl -Fo ./../volumetricFogExtinctionVolume_cs.dxil -Zi -Fd ./../volumetricFogExtinctionVolume_cs.pdb
dxc.exe -T cs_6_2 -E main volumetricFogExtinctionVolumeDebug_cs.hlsl -Fo ./../volumetricFogExtinctionVolumeDebug_cs.dxil -Zi -Fd ./../volumetricFogExtinctionVolumeDebug_cs.pdb
