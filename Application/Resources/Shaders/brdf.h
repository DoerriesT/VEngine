...
vec3 Diffuse_Disney(float NdotV, float NdotL, float VdotH, float roughness, vec3 baseColor)
{
...
vec3 Specular_GGX(vec3 F0, float NdotV, float NdotL, float NdotH, float VdotH, float a2)
{
