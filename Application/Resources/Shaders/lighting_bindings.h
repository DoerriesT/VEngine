...
#define OCCLUSION_IMAGE_BINDING 11
...
#define IRRADIANCE_VOLUME_WIDTH_CONST_ID 5
#define IRRADIANCE_VOLUME_HEIGHT_CONST_ID 6
#define IRRADIANCE_VOLUME_DEPTH_CONST_ID 7
#define IRRADIANCE_VOLUME_CASCADES_CONST_ID 8
#define IRRADIANCE_VOLUME_BASE_SCALE_CONST_ID 9
#define IRRADIANCE_VOLUME_PROBE_SIDE_LENGTH_CONST_ID 10
#define IRRADIANCE_VOLUME_DEPTH_PROBE_SIDE_LENGTH_CONST_ID 11
